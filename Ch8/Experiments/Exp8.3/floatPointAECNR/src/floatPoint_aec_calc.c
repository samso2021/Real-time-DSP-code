 ...
 *      Author: BLEE
 *
 *  Description: This is the Leaky Normalized LMS based AEC algorithms
 *
...
*************************************************************************/
  ...
  // Update near-endnoise floor estimate of signal pickup by microphone  
