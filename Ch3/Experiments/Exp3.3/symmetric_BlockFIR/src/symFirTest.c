 ...
 * symFirTest.c
 *
 * Description: This is the test file for the symmetric block FIR filter
 *
...
#pragma DATA_SECTION(symFirCoef, ".const:fir");
#pragma DATA_SECTION(w, ".bss:fir");

#include "symFirCoef.h"
...
void main()
{
    ...
    printf("Exp --- Symmetric_Block FIR filter experiment\n");
    ...
    while (fread(temp, sizeof(Uint8), NUM_DATA*2, fpIn) == (NUM_DATA*2))
    {
        ...
        symFir(x, NUM_DATA, symFirCoef, NUM_TAPS, y, w, &index);
