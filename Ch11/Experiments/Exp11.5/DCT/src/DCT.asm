...
;*      Author: BLEE
;*
;*  Description: This is the 8x8 DCT algorithm in assembly implemenation
;*
;*  Prototype: void dct8x8(short *block, short (*dctCoef)[8])
;*
...
;                                                     
;  First apply 1-D DCT on the columns of the 8x8 data block
;
    mov #7, BRC0
    mov #7, BRC1
    mov #8, T0                
...
||  rptblocal  columnLoop-1    ; for(i=0; i<8; i++)  
    mov  XSP, XAR4             ; curData = block + i
    amar *AR1, XAR2            ; tmpCoef = &dctCoef[0][0]
    aadd T1, AR4
