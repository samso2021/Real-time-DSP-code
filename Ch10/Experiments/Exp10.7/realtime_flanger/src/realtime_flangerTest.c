 /*
 * realtime_flangerTest.c
 *
 *  Created on: Oct 28, 2012
 *      Author: BLEE
 *
 *  Description: Test program for real-time flanger experiment
 *
...
void main(void)
{
    ...
    printf("Exp --- real-time flanger experiment\n");
    flanger_init();		// Initialize for experiment
    flanger();			// Real-time loop
}
