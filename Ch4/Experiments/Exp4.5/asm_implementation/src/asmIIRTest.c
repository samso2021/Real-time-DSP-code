...
*      Author: BLEE
*
*  Description: This is the test program for the assembly implementation of IIR filter in direct form-II
*
...
void main(void)
{
	...
	while (fread(temp, sizeof(Int8), NUM_DATA*2, fpIn) == (NUM_DATA*2))
	{
        ...
        asmIIR(in,NUM_DATA,out,C,SECTIONS,w); // Filter a block of samples  
