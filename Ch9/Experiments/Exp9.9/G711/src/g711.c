 ...
 *
 *  Description: This is the C file for ITUT G.711 functions
 *
...
{
  Int32            n;            /* samples's count */
  Int16           i;		/* aux.var. */
  Int16           absno;	/* absolute value of linear (input) sample */
  Int16           segno;	/* segment (Table 2/G711, column 1) */
  Int16           low_nibble;	/* low  nibble of log companded sample */
  Int16           high_nibble;	/* high nibble of log companded sample */
...
{
  Int32            n;		/* aux.var. */
  Int16           segment;	/* segment (Table 2/G711, column 1) */
  Int16           mantissa;	/* low  nibble of log companded sample */
  Int16           exponent;	/* high nibble of log companded sample */
  Int16           sign;		/* sign of output sample */
  Int16           step;
