...
/* Function prototypes */
void  alaw_compress ARGS((Int32 lseg, Int16 *linbuf, Int16 *logbuf));
void  alaw_expand ARGS((Int32 lseg, Int16 *logbuf, Int16 *linbuf));
void  ulaw_compress ARGS((Int32 lseg, Int16 *linbuf, Int8 *logbuf));
void  ulaw_expand ARGS((Int32 lseg, Int8 *logbuf, Int16 *linbuf));
