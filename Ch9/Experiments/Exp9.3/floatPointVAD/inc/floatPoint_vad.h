 ...
 *      Author: BLEE
 *
 *  Description: This is the C header file for floating-point VAD (voice activity detection) experiment
 *
...
typedef struct {
    ...
    float   *pwindow;       // Pointer for Hanning window
