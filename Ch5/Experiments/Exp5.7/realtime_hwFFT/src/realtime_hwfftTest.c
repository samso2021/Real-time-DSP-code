 /*
 * realtime_hwfftTest.c
 *
 *  Created on: June 11, 2012
 *      Author: BLEE
 *
 *  Description: Test program for FFT-iFFT experiment
 *
...
extern void hwFFT_init(void);
extern void hwFFT(void);
...
void main(void)
{
	...
	printf("Exp --- hardware accelerator based real-time FFT experiment\n");
	hwFFT_init();		   // Initialize for FFT
	hwFFT();			   // FFT loop
}
